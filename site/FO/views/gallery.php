...
<body> 
	...
	<div class="banner">
		...
		<div class="header">
			<div class="container">
				<div class="logo">
					<h1><a href="gallery.php">Mimosas</a></h1>
				</div> 
				<div class="menu">
					<a href="#" class="navicon"></a> 
					<div class="toggle"> 
						<ul class="toggle-menu">
							<li><a href="gallery.php" class="active"> Produit</a></li>
		...
		<div class="banner-text w3labout-bnr"> 
			<div class="container">  
				<h2><a href="gallery.php">Home</a> / Nos Produit</h2>
			</div>
		</div>
		<!-- //banner-text -->
	</div>
				...
				<div class="col-xs-4 agileits_w3layouts_gallery_grid">
                    ...
                    <div class="agileits_w3layouts_gallery_grid1 hover14 column">
                        <div class="w3_agile_gallery_effect">
                            <a href="images/<?php echo $row['img']; ?>" class="sb" title="prix: <?php echo  $row['prix']; ?>€">

                            <figure>
                              <div>
                                    <img src="images/<?php echo $row['img']; ?>" alt="" class="img-responsive" height="50%" width="50%">
		...
		<div class="container">
			...
			<div class="col-md-4 col-sm-4 agileinfo_footer_grid">
				...
				<ul>
					...
					<li><span class="glyphicon glyphicon-earphone" aria-hidden="true"></span> (216) 26 215 365</li>
				</ul>
			</div> 
			<div class="clearfix"> </div>
